...
//
//=============================================================================
int conrec(double **d,// d matrix of data to contour
           int iub,   // iub upper index of rows data matrix
           int jub,   // jub upper index columns of data matrix
           double *x, // x  data matrix column coordinates
           double *y, // y  data matrix row coordinates
           int nc,    // nc number of contour levels
           double *z, // z  contour levels in increasing order
           // This is a function that will get called for each segment created
           void (*ConrecLine)(double,double,double,double,double)
           ){
    int m1, m2, m3, case_value;
    double dmin, dmax, x1, x2, y1, y2;
    //  register int i,j,k,m;
    int ilb = 0; // should get rid of these - C always indexes from zero
    int jlb = 0; // should get rid of these - C always indexes from zero
    int i, j, k, m;
    double h[5];
    int sh[5];
    double xh[5], yh[5];
                    ...
                    if (z[k] >= dmin && z[k] <= dmax) {
                        ...
                        for (m = 1; m <= 4; m++) {
                            ...
                            if (case_value != 0) {
                                ...
                                //========================================================================
                                // This calls the passed-in function with the information for that segment
                                //========================================================================
